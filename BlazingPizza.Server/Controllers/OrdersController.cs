...
namespace BlazingPizza.Server
{
    ...
    public class OrdersController : Controller
    {
        ...
        public OrdersController(KotaStoreContext db)
        {
            _db = db;
        }
        ...
        public async Task<ActionResult<List<OrderWithStatus>>> GetOrders()
        {
            var orders = await _db.Orders
                ...
                .Include(o => o.Kotas).ThenInclude(p => p.Special)
                .Include(o => o.Kotas).ThenInclude(p => p.Toppings).ThenInclude(t => t.Topping)
        ...
        public async Task<ActionResult<int>> PlaceOrder(Order order)
        {
            ...
            // Enforce existence of Kota.SpecialId and Topping.ToppingId
            // in the database - prevent the submitter from making up
            // new specials and toppings
            foreach (var pizza in order.Kotas)
            {
